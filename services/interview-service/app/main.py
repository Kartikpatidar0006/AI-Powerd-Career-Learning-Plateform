"""
services/interview-service/app/main.py
----------------------------------------
FastAPI entrypoint for the Interview Service.
Handles: Interviews, Interview Engine, AI Evaluation.
Publishes: interview.completed events to RabbitMQ.
"""
...
async def lifespan(app: FastAPI) -> AsyncIterator[None]:
    ...
    initialize_database()
    logger.info("✓  Interview Service ready.")
    yield
    logger.info("Interview Service shutdown.")


app = FastAPI(
    title=settings.PROJECT_NAME,
    version=settings.PROJECT_VERSION,
    description="Interview microservice: Mock Interviews, AI Evaluation.",
...
# ── Routers ────────────────────────────────────────────────────────────────── #
from app.api.v1.interviews.router import router as interviews_router  # noqa: E402
from app.api.v1.ai.router import router as ai_router                  # noqa: E402

prefix = settings.API_V1_STR
app.include_router(interviews_router, prefix=f"{prefix}/interviews", tags=["Interviews"])
